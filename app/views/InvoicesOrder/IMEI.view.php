...
<div class="container">
    ...
    <table class="table">
        ...
        <?php  if($orders): foreach ($orders as $value): ?>
            ...
            <tr>
                <td><a href="/invoicesOrder/show/IMEI/<?= $value->imei_order_id ?>">#<?= $value->imei_order_id ?></a></td>
                ...
                <td>
                    <a class="button xs process" onclick="changeStatus('invoicesOrder/status/IMEI', this, '1', '<?= $value->imei_order_id ?>')" ><?= $text_status[1] ?> <i class="fas fa-check"></i></a>
                    <a class="button xs success" onclick="changeStatus('invoicesOrder/status/IMEI', this, '3', '<?= $value->imei_order_id ?>')" ><?= $text_status[3] ?> <i class="fas fa-fan"></i></a>
                    <a class="button xs danger" onclick="changeStatus('invoicesOrder/status/IMEI', this, '4', '<?= $value->imei_order_id ?>')" ><?= $text_status[4] ?> <i class="icon-cancel"></i></a>
                    <a class="button xs danger" onclick="changeStatus('invoicesOrder/status/IMEI', this, '5', '<?= $value->imei_order_id ?>')" ><?= $text_status[5] ?>  <i class="icon-cancel"></i></a>
