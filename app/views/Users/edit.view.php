<div class="container">
      <form class="form" method="post">
            ...
            <div class="input-section">
                  <input type="text" name="userName" id="userName" autocomplete="off" value="<?= $this->showValue('userName', $user, 'user_name') ?>" >
            ...
            <div class="input-section">
                  <input type="email" name="email" id="email" autocomplete="off" value="<?= $this->showValue('email', $user, 'user_email') ?>">
...
<?php foreach($usersGroup as $value): ?>
                  <option value="<?= $value->group_id ?>" <?= $this->selected('usersGroup', $value->group_id, $user,'user_group_id')?> ><?= $value->group_name ?></option>
<?php endforeach; ?>
            </select>
