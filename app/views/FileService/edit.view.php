    ...
    <form class="form" method="post">
        <div class="input-section">
            <input type="text" name="serviceTitle" id="serviceTitle"
                   value="<?= $this->showValue('serviceTitle', $services, 'file_service_title') ?>" autocomplete="off">
        ...
        <div class="input-section">
            <input type="text" name="servicePrice" id="servicePrice"
                   value="<?= $this->showValue('servicePrice', $services, 'file_service_price') ?>" autocomplete="off">
        ...
        <div class="input-section">
            <input type="text" name="serviceCostPrice" id="serviceCostPrice"
                   value="<?= $this->showValue('serviceCostPrice', $services, 'file_service_cost_price') ?>"
                   autocomplete="off">
        ...
        <div class="input-section">
            <input type="text" name="serviceReceivedTime" id="serviceReceivedTime"
                   value="<?= $this->showValue('serviceReceivedTime', $services, 'file_service_orders_received') ?>"
                   autocomplete="off">
        ...
        <div class="input-section">
            <input type="text" name="deliveryTime" id="deliveryTime"
                   value="<?= $this->showValue('deliveryTime', $services, 'file_service_delivery_time') ?>">
            <label for="deliveryTime" class="input-content"><span><?= $text_form_deliveryTime ?></span></label>
        </div>
        <div class="input-section">
            <input type="text" name="serviceUri" id="serviceUri"  value="<?= $this->showValue('serviceUri', $services, 'file_service_url')?>" >
            <label for="serviceUri" class="input-content"><span><?= $text_form_uri ?></span></label>
        </div>
        ...
        <textarea id="editor"
                  name="serviceContent"><?= html_entity_decode($this->showValue('serviceContent', $services, 'file_service_content')) ?></textarea>
        <div>
            <input type="radio" value="2" name="visibility" hidden checked>
            <input type="radio" id="ves-yes" value="1"
                   name="visibility" <?= $this->checked('visibility', '1', $services, 'file_service_visibility') ?> >
            <label for="ves-yes"><?= $text_form_serviceVisible ?></label>
            <input type="radio" id="ves-no" value="0"
                   name="visibility" <?= $this->checked('visibility', '0', $services, 'file_service_visibility') ?>>
        ...
        <div>
            ...
            <input type="radio" id="verification-yes" value="1"
                   name="verification" <?= $this->checked('verification', '1', $services, 'file_service_orders_verification') ?> >
            <label for="verification-yes"><?= $text_form_verificationOK ?></label>
            <input type="radio" id="verification-no" value="0"
                   name="verification" <?= $this->checked('verification', '0', $services, 'file_service_orders_verification') ?>>
