...
<?php endforeach; endif;?>
          ...
          <div>
              ...
              <input type="radio" id="return-yes" value="1" name="return" <?= $this->checked('return', '1', $services, 'file_service_orders_return') ?> >
              <label for="return-yes"><?= $text_form_returnOK ?></label>
              <input type="radio" id="return-no"value="0"  name="return" <?= $this->checked('return', '0', $services, 'file_service_orders_return') ?>>
