<div class="container">
    <form class="form" method="post">
        ...
        <div class="input-section">
            <input type="text" name="serviceTimeVerify" id="serviceTimeVerify"
                   value="<?= $this->showValue('serviceTimeVerify') ?>" autocomplete="off">
            <label for="serviceTimeVerify"
        ...
        <div class="input-section">
            <input type="text" name="ServiceUrl" id="ServiceUrl"
                   value="<?= $this->showValue('ServiceUrl') ?>">
        ...
        <div>
            <input type="radio" value="2" name="return" hidden checked>
            <input type="radio" id="return-yes" value="1" name="return" <?= $this->checked('return', '1') ?> >
            <label for="return-yes"><?= $text_form_returnOK ?></label>
            <input type="radio" id="return-no" value="0" name="return" <?= $this->checked('return', '0') ?>>
            <label for="return-no"><?= $text_form_returnNO ?></label>
        </div>
